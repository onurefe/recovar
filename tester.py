...
from monitor_models import (
    AugmentationCrossCovarianceMonitor30s,
...
"""
# Create kfold environment which is used for training and testing.
exps = [
    {
        "name": "no_aug",
        "noise_enabled": False,
...
for exp in exps[0:4]:
    for dataset in [
        ...
        tester = KFoldTester(
            ...
            monitor_ctor=AugmentationCrossCovarianceMonitor30s,
        )
        ...
        tester.test(
            ...
            method_params={
                "epoch": 10,
                "noise_augmentation_params": {
                    "weight": 0.2,
                    "enabled": exp["noise_enabled"],
                },
                "dispersion_augmentation_params": {
                    ...
                    "knots": 4,
                    "enabled": exp["dispersion_enabled"],
                },
                "timewarping_params": {
                    "std": 0.25,
                    "knots": 4,
                    "enabled": exp["timewarp_enabled"],
                },
            },
        )
"""
...
for dataset in [
    ...
    tester.test_samples(
        exp_name="autocovaraince_detector_30s_for_plots",
        splits=[0],
        monitor_params=["x", "f", "fcov"],
        method_params={"epoch": 19},
        n_batches_per_split=1,
    )
