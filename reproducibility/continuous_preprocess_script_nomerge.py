import os
import obspy
from continuous_data_processor_nomerge import ContinuousDataPreprocessor
...
preprocessor = ContinuousDataPreprocessor(
    ...
    output_hdf5_path=f"output/SLVT_continuous_waveforms_nomerge.hdf5",
    output_metadata_csv_path=f"output/SLVT_continuous_metadata_nomerge.csv",
    window_length=60,
    sampling_rate=100
)
