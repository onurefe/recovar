...
CUSTOM_WAVEFORMS_HDF5_PATH = settings["DATASET_DIRECTORIES"]["CUSTOM_WAVEFORMS_HDF5_PATH"]
CUSTOM_METADATA_CSV_PATH = settings["DATASET_DIRECTORIES"]["CUSTOM_METADATA_CSV_PATH"]
