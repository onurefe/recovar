...
CONTINUOUS_WAVEFORMS_HDF5_PATH = settings["DATASET_DIRECTORIES"]["CONTINUOUS_WAVEFORMS_HDF5_PATH"]
CONTINUOUS_METADATA_CSV_PATH = settings["DATASET_DIRECTORIES"]["CONTINUOUS_METADATA_CSV_PATH"]
